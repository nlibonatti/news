...
$url = array(
             array("title" => "Ole",
                   "html" => "https://www.ole.com.ar/rss/ultimas-noticias/",
                   "page" => "https://www.ole.com.ar/",
                   "fav" => "./img/ole.gif"),
                   
             array("title" => "ESPN",
                   "html" => "http://www.espn.com.ar/espn/rss/news", 
                   "page" => "http://www.espn.com.ar",
                   "fav" => "./img/espn.png"),

             array("title" => "Página 12 Deportes",
                   "html" => "https://www.pagina12.com.ar/rss/secciones/deportes/notas", 
                   "page" => "hhttps://www.pagina12.com.ar/secciones/deportes",
                   "fav" => "./img/pagina.gif"), 

             array("title" => "Clarín Deportes",
                   "html" => "https://www.clarin.com/rss/deportes/", 
                   "page" => "https://www.clarin.com/deportes/",
                   "fav" => "./img/clarin.png"), 

             array("title" => "AS Argentina",
                   "html" => "https://argentina.as.com/rss/argentina/portada.xml", 
                   "page" => "https://argentina.as.com/",
                   "fav" => "./img/as.png"),

            array("title" => "Ambito Deportes",
                   "html" => "https://www.ambito.com/rss/deportes.xml", 
                   "page" => "https://www.ambito.com/",
                   "fav" => "./img/ambito.jpeg"),
                   
             array("title" => "El Gráfico",
                   "html" => "https://www.elgrafico.com.ar/rss", 
                   "page" => "https://www.elgrafico.com.ar/",
                   "fav" => "./img/elgrafico.gif")
				);
  ?>
...
<script>
  ...
  gtag('config', 'AW-1038288710');
    ...
    <meta name="description" content="Noticias y Diarios Argentinos - Deportes. Información en un sólo lugar. Diarios de Argentina. Noticias de Argentina. Periódicos de Argentina. Información del Mundo.">
    ...
    <title>Deportes - Noticias de Deportes - 24 Diario</title>
</head>
...
<?php include ('header.php');?>
  ...
  <div class="container">
  <div class="row ml-3">
 <h1>Argentina - Noticias de Deportes</h1>
 </div>
 ...
 <h2><p class="font-weight-bold mb-0">Últimas Noticias</p></h2>
    ...
    <?php 
      $cachefile = '/home/diarioarg/24diario.com.ar/deportes.html';
