...
$url = array(
             array("title" => "IProUp",
                   "html" => "https://www.iproup.com/rss/home",
                   "page" => "https://www.iproup.com",
                   "fav" => "./img/iproup.gif"),
                   
             array("title" => "Clarín Tecnología",
                   "html" => "https://www.clarin.com/rss/tecnologia/", 
                   "page" => "http://www.clarin.com/tecnologia/",
                   "fav" => "./img/clarin.png"), 
                   
             array("title" => "Hipertextual",
                   "html" => "https://feed.hipertextual.com/", 
                   "page" => "https://www.hipertextual.com/",
                   "fav" => "./img/hipertextual.png"), 

             array("title" => "Genbeta",
                   "html" => "http://feeds.weblogssl.com/genbeta", 
                   "page" => "https://www.genbeta.com/",
                   "fav" => "./img/genbeta.gif"), 
                   
             array("title" => "Applesfera",
                   "html" => "http://feeds.weblogssl.com/applesfera", 
                   "page" => "https://www.applesfera.com/",
                   "fav" => "./img/applesfera.gif"),

             array("title" => "Gizmodo",
                   "html" => "https://es.gizmodo.com/rss", 
                   "page" => "https://es.gizmodo.com/",
                   "fav" => "./img/gizmodo.png"),

             array("title" => "Wwwhatsnew",
                   "html" => "http://feeds2.feedburner.com/Wwwhatsnew",
                   "page" => "https://wwwhatsnew.com/",
                   "fav" => "./img/wwwhatsnew.png")
				);
  ?>
...
<script>
  ...
  gtag('config', 'AW-1038288710');
    ...
    <meta name="description" content="Noticias y Diarios Argentinos - Tecnología. Información en un sólo lugar. Diarios de Argentina. Noticias Argentinas. Periódicos de Argentina. Información del Mundo.">
    ...
    <title>Tecnología - Noticias de Tecnología - 24 Diario</title>
</head>
...
<?php include ('header.php');?>
  ...
  <div class="container">
  <div class="row ml-3">
 <h1>Argentina - Noticias de Tecnología</h1>
 </div>
 ...
 <h2><p class="font-weight-bold mb-0">Últimas Noticias</p></h2>
    ...
    <?php 
      $cachefile = '/home/diarioarg/24diario.com.ar/tecnologia.html';
