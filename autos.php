...
$url = array(
   ...
   array("title" => "Motor 1",
      "html" => "https://ar.motor1.com/rss/articles/all/",
       "page" => "https://ar.motor1.com/",
       "fav" => "./img/autoblog.gif"),

   array("title" => "Autocosmos",
        "html" => "https://feeds.feedburner.com/ac/rss-ar",
        "page" => "https://www.autocosmos.com.ar/",
        "fav" => "./img/general.png"),

   array("title" => "Parabrisas",
        "html" => "https://parabrisas.perfil.com/feed",
        "page" => "https://parabrisas.perfil.com/",
        "fav" => "./img/parabrisas.gif"),

   array("title" => "16 Valvulas",
        "html" => "http://feeds.feedburner.com/16valvulas", 
        "page" => "https://www.16valvulas.com.ar/",
        "fav" => "./img/16valvulas.gif"),
        
  array("title" => "Tiempo Motor",
        "html" => "https://tiempomotor.com/feed/", 
        "page" => "https://tiempomotor.com/",
        "fav" => "./img/tiempomotor.png"),

  array("title" => "Iprofesional Autos",
        "html" => "https://www.iprofesional.com/rss/autos", 
        "page" => "https://www.iprofesional.com/autos",
...
<script>
  ...
  gtag('config', 'AW-1038288710');
    ...
    <meta name="description" content="Noticias y Diarios Argentinos - Autos. Información en un sólo lugar. Diarios de Argentina. Noticias Argentinas. Periódicos de Argentina. Información del Mundo.">
    ...
    <title>Autos - Noticias de Autos - 24 Diario</title>
</head>
...
<?php include ('header.php');?>
  ...
  <div class="container">
  <div class="row ml-3">
 <h1>Argentina - Noticias de Autos</h1>
 </div>
 ...
 <h2><p class="font-weight-bold mb-0">Últimas Noticias</p></h2>
    ...
    <?php 
      $cachefile = '/home/diarioarg/24diario.com.ar/autos.html';
